class CatalogPageManager {
    ...
    createCategoryCard(service) {
        ...
        return `
            <div class="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:transform hover:-translate-y-2 overflow-hidden cursor-pointer border border-gray-100 hover:border-orange-200" onclick="catalogPageManager.showCategoryProducts('${service.name}')">
    ...
    createProductCard(product) {
        ...
        return `
            <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:transform hover:-translate-y-1 overflow-hidden border border-gray-100 hover:border-orange-200">
                <div class="relative">
                ...
                <div class="p-6">
                    ...
                    <div class="border-t border-gray-100 pt-4">
                        ...
                        <button onclick="catalogPageManager.requestQuote('${product.name.replace(/'/g, "\\'")}')" 
        ...
        this.showModal(`
            <div class="text-center">
                ...
                <div class="space-y-3 mb-8">
                    <a href="tel:+996555555555" class="flex items-center justify-center space-x-3 bg-orange-600 hover:bg-orange-700 text-white px-6 py-4 rounded-lg transition-colors duration-200 font-semibold">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                        </svg>
                        <span>+996 (555) 555-555</span>
                    </a>
                    <a href="mailto:info@bishtrade.kz" class="flex items-center justify-center space-x-3 bg-gray-100 hover:bg-gray-200 text-gray-700 px-6 py-4 rounded-lg transition-colors duration-200 font-medium">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
